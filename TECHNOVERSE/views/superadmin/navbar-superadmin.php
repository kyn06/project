...
<div class="fixed-sidebar d-none d-md-block" id="sidebarMenu">
    ...
    <ul class="list-unstyled mt-5">
        <li class="mb-3"><a href="../views/superadmin/index.php" class="sidebar-link"><i class="fas fa-home me-2"></i>Home</a></li>
        <li class="mb-3"><a href="../views/jobseeker/js-status.php" class="sidebar-link"><i class="fas fa-user me-2"></i>User Management</a></li>
        ...
        <li><a href="../auth/logout.php" class="sidebar-link" style="color: #ff1d1d;"><i class="fas fa-sign-out-alt me-2"></i><strong>Logout</strong></a></li>
    </ul>
</div>
